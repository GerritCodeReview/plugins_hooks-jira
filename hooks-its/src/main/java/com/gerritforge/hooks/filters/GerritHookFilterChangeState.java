...
public class GerritHookFilterChangeState extends GerritHookItsFilter implements
    GerritHookFilter {
  ...
  public void doFilter(CommentAddedEvent hook) throws IOException {
    try {
      ...
      performAction(hook.change, conditions.toArray(new Condition[conditions.size()]));
    }
